class InfixApi {
  static String root = 'https://androidapp.uxseven.com/';
  ...
  static String attendanceDataSend(
      String id, String atten, String date, String mClass, String mSection) {
    return baseApi +
        "student-attendance-store-second?id=" +
        id +
        "&attendance=" +
        atten +
        "&date=" +
  ...
  static String getJoinMeetingUrl({mid}) {
