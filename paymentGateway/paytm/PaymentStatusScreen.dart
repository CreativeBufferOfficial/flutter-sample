...
class DrawCircle extends CustomPainter{
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(Offset(size.width/2, size.height/2), 50.0*leftLineFraction, _paint);
    canvas.drawCircle(Offset(size.width/2, size.height/2), 30.0*rightLineFraction, _paint1);
  }
